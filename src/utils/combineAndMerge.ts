...
export function combineAndMerge<O1, O2, O3>(
  o1: O<O1>, o2: O<O2>, o3: O<O3>
): O<O1 | O2 | O3>;
export function combineAndMerge<O1, O2, O3, O4>(
  o1: O<O1>, o2: O<O2>, o3: O<O3>, o4: O<O4>
): O<O1 | O2 | O3 | O4>;
export function combineAndMerge<O1, O2, O3, O4, O5>(
  o1: O<O1>, o2: O<O2>, o3: O<O3>, o4: O<O4>, o5: O<O5>
): O<O1 | O2 | O3 | O4 | O5>;
export function combineAndMerge<O1, O2, O3, O4, O5, O6>(
  o1: O<O1>, o2: O<O2>, o3: O<O3>, o4: O<O4>, o5: O<O5>, o6: O<O6>
): O<O1 | O2 | O3 | O4 | O5 | O6>;
